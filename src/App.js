...
import selectOptions from "./util/selectOption.json";
import controlList from "./util/controls.json";
    ...
    return (
      <div className="wrapper">
        <div className="wrapperInner">
          <h2 className="heading">Simple React Loan & Mortgage Calculator</h2>
